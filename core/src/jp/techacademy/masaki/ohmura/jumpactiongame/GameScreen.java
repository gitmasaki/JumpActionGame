package jp.techacademy.masaki.ohmura.jumpactiongame;
...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.masaki.ohmura.jumpactiongame"); // ←追加する
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() >= 0.8f) {
                ...
                enemy.setPosition(mRandom.nextFloat() * (WORLD_WIDTH - Enemy.ENEMY_WIDTH), y / 2 + mRandom.nextFloat() * (WORLD_WIDTH - Enemy.ENEMY_HEIGHT));
                mEnemy.add(enemy);
            }
